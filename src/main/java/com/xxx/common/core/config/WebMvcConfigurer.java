        ...
        exceptionResolvers.add(new HandlerExceptionResolver() {
            public ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception e) {
                ...
                if (e instanceof ServiceException) {//业务失败的异常，如“账号或密码错误”
                    result = new ResponseMsg("501", "接口 [" + request.getRequestURI() + "] 业务层出错：" + e.getMessage() + (e.getCause() == null ? "" : "====>>{报错日志（请把此日志截图给此接口开发人员）：" + e.getCause().getMessage() + "}"));
                    logger.info(e.getMessage());
                } else if (e instanceof NoHandlerFoundException) {
                    result = new ResponseMsg("404", "接口 [" + request.getRequestURI() + "] 不存在!");
                } else {
                    result = new ResponseData("500", "接口 [" + request.getRequestURI() + "] 服务端错误，请联系后台开发人员!", "报错日志（请把此日志截图给此接口开发人员）：" + e.getMessage());
                    String message;
